		...
		<div class="row">
			...
			<div class="col-sm-12 col-md-6">
				...
				<div class="col-sm-12 button-holder">
					...
					<span style="font-size:28px; padding-left:5px; padding-right:5px; color:#ABADB0;">OR</span><a href="mailto:?subject=Are your kids hungry?&body=The US Department of Agriculture's school lunch and breakfast programs provide millions of free and low-cost meals to kids like yours every day. It's easy to apply. Just click this link and fill out the form.%0D%0A  %0D%0A http://usda-eat.us-east-1.elasticbeanstalk.com/"><span class="glyphicon glyphicon-envelope" style="font-size:24px; color:#038bce; padding-left:10px; padding-right:5px;"></span><span style="font-size:28px; color: #038bce;  text-decoration: none;">Share</span></a>
				</div>
			</div>
		</div>
	</div>
